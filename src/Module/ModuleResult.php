...
class ModuleResult implements \JsonSerializable
{
    ...
    /**
     * @var ArieTimmerman\Laravel\AuthChain\Object\SubjectInterface
     */
    protected $subject;
    ...
    /**
     * @var ArieTimmerman\Laravel\AuthChain\Module\Module
     */
    protected $module;
     ...
     *
     * @return \ArieTimmerman\Laravel\AuthChain\Object\SubjectInterface
     */
    ...
    {
        $module = $json ? resolve('ArieTimmerman\Laravel\AuthChain\Repository\ModuleRepositoryInterface')->get($json->module) : null;
